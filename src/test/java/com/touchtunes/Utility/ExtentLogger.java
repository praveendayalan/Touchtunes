	...
	public static void startReport()
     {
         ...
         htmlReporter.config().setReportName("Saavn Test Automation Report");
         htmlReporter.config().setDocumentTitle("Saavn - Automation Report"); 
         htmlReporter.config().setEncoding("UTF-8");
         extReports = new ExtentReports();
         extReports.setSystemInfo("Environment", "Test");
